...
// Enable Yoast fields in REST API for posts - FIXED with correct meta keys
add_action('rest_api_init', function() {

 // Register Yoast focus keyphrase - CORRECT KEY: _yoast_wpseo_focuskw
 ...
 // Register Yoast meta description - CORRECT KEY: _yoast_wpseo_metadesc
 ...
 // Register Yoast title - CORRECT KEY: _yoast_wpseo_title
