...
## Active Task
- **Task Description:** Implement index validation tests
- **Task Contract ID:** task_20260526_004355_5aa5
- **Staged Outputs:** projects/rank-ray-hq/
...
3. [ ] **Dynamic Skill Check:** Resolve skills using `resolve-skills.py` for this task.
4. [ ] **Locking & Transaction Write:** Log every single completed action/delta using `scripts/agent-ledger.py log`.
5. [ ] **Output Isolation:** Never create local files/drafts in your workspace. Write all output artifacts directly to `projects/{{project}}/` or the designated directory.
