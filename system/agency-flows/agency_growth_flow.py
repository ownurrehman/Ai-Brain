...
class AgencyGrowthState(BaseModel):
    ...
    mission_goal: str = "Scale RankRay SEO client acquisition and organic traffic via automated technical audits"
    target_domain: str = "rankray.com"
    target_niche: str = "B2B Technical SEO & White-Label Link Building Agency"
...
class AgencyGrowthFlow(Flow[AgencyGrowthState]):
    ...
    def execute_content_and_outreach(self):
        ...
        outreach_task = Task(
            ...
            Draft a 3-step value-first Cold Outreach Sequence (Subject Lines + Email Body):
