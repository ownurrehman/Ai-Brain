...
## Strict Rules
- **No Workspace Leaks:** You must write deliverables ONLY into `projects/{{project_name}}/`, `clients/{{client_name}}/`, or `websites/{{website_name}}/`. Writing files in `agents/` is a critical violation of system isolation rules.
