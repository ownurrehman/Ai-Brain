...
- **Workspace:** ~/Ai Works - Local/Ai Codes/Ai Brain/openclaw
...
- **Workspace:** ~/Ai Works - Local/Ai Codes/Ai Brain/openclaw/chronos
- **Tools:** browser, canvas, message, heartbeat_respond, nodes, agents_list, tts, file_fetch, dir_list, firecrawl_scrape, firecrawl_search
...
- **Workspace:** ~/Ai Works - Local/Ai Codes/Ai Brain/openclaw/nemo
