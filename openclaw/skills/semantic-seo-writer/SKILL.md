...
**Rule:** 5-10 internal links per article, verified from sitemap.

**Process:**
1. Fetch site sitemap (sitemap_index.xml → post-sitemap.xml + page-sitemap.xml)
2. Extract all URLs
3. Match URLs to article sections (relevance > exact match)
...
**Rule:** 1 image per main H2 section + 1 featured image.

**For 10 H2 sections = 11 images total.**
...
- [ ] Internal links: 5-10, all verified from sitemap
- [ ] Images: 1 per H2 + featured, all unique, all with alt text
- [ ] Meta title: <60 chars
