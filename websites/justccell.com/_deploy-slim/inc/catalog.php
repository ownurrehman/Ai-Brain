...
function justccell_catalog_groups(string $category): array
{
    $groups = [
        'all-in-ones' => [
            ['title' => 'Best For Distillates', 'slugs' => ['mini-tank', 'voca', 'flexcell', 'ds0103', 'skye-ii', 'listo']],
            ['title' => 'Best For Live Rosins', 'slugs' => ['rosin-bar', 'vision-box-elite']],
            ['title' => 'Best For Live Resins', 'slugs' => ['flexcell-pro', 'voca-pro', 'blanc', 'slym']],
            ['title' => 'All-Oil-Capable', 'slugs' => ['flexcell-x', 'tank', 'eco-star', 'vision-box', 'voca-pro-max', 'voca-max']],
        ],
        'cartridge' => [
            ['title' => '', 'slugs' => ['ceramic-evomax', 'th2-evomax', 'm6t-evomax', 'th2-se', 'm6t-se']],
        ],
        'pod-system' => [
            ['title' => '', 'slugs' => ['luster-pro', 'dart-x', 'dart', 'bellos', 'luster-pro-pod', 'dart-pod', 'bellos-pod']],
        ],
        'battery' => [
            ['title' => '', 'slugs' => ['stylo', 'fino', 'sandwave', 'go-stik', 'palm-pro', 'm3b-plus', 'm3-plus']],
        ],
    ];
