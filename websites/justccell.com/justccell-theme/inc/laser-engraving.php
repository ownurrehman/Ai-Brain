...
/**
 * Register group_jc_laser_engraving (product). Category defaults group is registered for
 * programmatic term-meta fallbacks only — hidden from admin UI in admin-laser-zone.php.
 */
add_action('acf/init', static function (): void {
    ...
    acf_add_local_field_group(justccell_acf_laser_engraving_global_group());
    acf_add_local_field_group(justccell_acf_laser_engraving_product_group());
    acf_add_local_field_group(justccell_acf_laser_engraving_category_group());
});

/**
 * Global engraving pricing — Justccell → Laser Engraving.
 *
 * @return array<string, mixed>
 */
function justccell_acf_laser_engraving_global_group(): array
{
    return [
        'key'    => 'group_jc_laser_engraving_global',
        'title'  => 'Laser Engraving',
        'fields' => [
            [
                'key'     => 'field_jc_laser_global_intro',
                'label'   => '',
                'name'    => '',
                'type'    => 'message',
                'message' => '<p>Setup fee and tiered per-unit engraving prices apply to <strong>all</strong> products with laser engraving enabled. Product and category screens only control canvas / safe zones.</p>',
                'new_lines' => '',
                'esc_html'  => 0,
            ],
            [
                'key'           => 'field_jc_laser_global_setup',
                'label'         => 'Setup fee',
                'name'          => 'laser_global_setup_fee',
                'type'          => 'number',
                'min'           => 0,
                'step'          => '0.01',
                'default_value' => 25,
                'instructions'  => 'One-time engraving setup fee per cart line (ex VAT, store currency).',
                'wrapper'       => ['width' => '33'],
            ],
            [
                'key'           => 'field_jc_laser_global_whatsapp_req',
                'label'         => 'Require WhatsApp for proof',
                'name'          => 'laser_whatsapp_required',
                'type'          => 'true_false',
                'ui'            => 1,
                'default_value' => 0,
                'instructions'  => 'When on, customers must enter a WhatsApp number before adding an engraved item to cart.',
                'wrapper'       => ['width' => '33'],
            ],
            [
                'key'          => 'field_jc_laser_global_tiers',
                'label'        => 'Tiered engraving pricing matrix',
                'name'         => 'laser_global_tiered_pricing_matrix',
                'type'         => 'repeater',
                'layout'       => 'table',
                'button_label' => 'Add qty band',
                'instructions' => 'Per-unit engraving price by order quantity. Max qty 0 = open-ended band.',
                'wrapper'      => ['width' => '100'],
                'sub_fields'   => [
                    [
                        'key'   => 'field_jc_laser_global_tier_min',
                        'label' => 'Min qty',
                        'name'  => 'min_qty',
                        'type'  => 'number',
                        'min'   => 1,
                    ...
                    [
                        'key'   => 'field_jc_laser_global_tier_max',
                        'label' => 'Max qty (0 = open)',
                        'name'  => 'max_qty',
                        'type'  => 'number',
                        'min'   => 0,
                        'step'  => 1,
                    ...
                    [
                        'key'   => 'field_jc_laser_global_tier_ppu',
        ...
        'location' => [[[
            'param'    => 'options_page',
            'operator' => '==',
            'value'    => 'justccell-laser-settings',
        ]]],
        'active' => true,
    ];
}
...
/**
 * Product field group — section 3.1.
 *
 * @return array<string, mixed>
 */
function justccell_acf_laser_engraving_product_group(): array
{
    $when_enabled = [[[
        'field'    => 'field_jc_laser_enable',
        'operator' => '==',
        'value'    => '1',
    ]]];

    return [
        'key'                   => 'group_jc_laser_engraving',
        'title'                 => 'Laser engraving (buy box)',
        'fields'                => [
            [
                'key'       => 'field_jc_laser_tab_general',
                'label'     => 'General Setup',
                'name'      => '',
                'type'      => 'tab',
                'placement' => 'top',
            ...
            [
                'key'           => 'field_jc_laser_enable',
                'label'         => 'Enable laser engraving editor',
                'name'          => 'enable_engraving',
                'type'          => 'true_false',
                'ui'            => 1,
                'default_value' => 0,
                'instructions'  => 'Master switch. Off = no UI, no scripts, no cart path.',
                'wrapper'       => ['width' => '25'],
            ],
            [
                'key'               => 'field_jc_laser_pricing_note',
                'label'             => '',
                'name'              => '',
                'type'              => 'message',
                'message'           => '<p>Engraving setup fee and tiered unit prices are managed globally under <strong>Justccell → Laser Engraving</strong>.</p>',
                'new_lines'         => '',
                'esc_html'          => 0,
                'conditional_logic' => $when_enabled,
            ],
            [
                'key'       => 'field_jc_laser_tab_canvas',
                'label'     => 'Engraving Canvas',
                'name'      => '',
                'type'      => 'tab',
                'placement' => 'top',
                'endpoint'  => 0,
            ...
            [
                'key'               => 'field_jc_laser_canvas_bg',
                'label'             => 'Canvas background image',
                'name'              => 'canvas_background_image',
                'type'              => 'image',
                'return_format'     => 'array',
                'preview_size'      => 'medium',
                'instructions'      => 'Device plate shown under the Fabric canvas. Upload here, then drag the red safe zone in the mapper below.',
                'conditional_logic' => $when_enabled,
            ],
            [
                'key'               => 'field_jc_laser_zones',
                'label'             => 'Safe zone coordinates',
                'name'              => 'safe_zone_coordinates',
                'type'              => 'repeater',
                'layout'            => 'table',
                'button_label'      => 'Add safe zone',
                'instructions'      => 'Pixel rectangles on the Fabric design canvas (640×640). Prefer the visual Safe zone mapper under the canvas background — these numbers update automatically.',
                'sub_fields'        => [
                    [
                        'key'   => 'field_jc_laser_zone_x',
                        'label' => 'X',
                        'name'  => 'x',
                        'type'  => 'number',
                        'step'  => 1,
            ...
            [
                'key'               => 'field_jc_laser_zones_json',
                'label'             => 'Safe zone JSON (optional)',
                'name'              => 'safe_zone_json',
                'type'              => 'textarea',
                'rows'              => 3,
                'instructions'      => 'Optional JSON array of {x,y,width,height} merged with the repeater.',
                'conditional_logic' => $when_enabled,
            ],
        ],
        'location'              => [[
...
/**
 * Flat map of laser product ACF fields for admin sync / hiding removed UI.
 *
 * @return array<string, array<string, mixed>>
 */
function justccell_acf_laser_engraving_product_field_map(): array
{
    static $map = null;
    if (is_array($map)) {
        return $map;
    ...
    $walk(justccell_acf_laser_engraving_product_group()['fields'] ?? []);
    $walk(justccell_acf_laser_engraving_global_group()['fields'] ?? []);
    return $map;
}
...
add_filter('acf/prepare_field', static function ($field) {
    ...
    if ($key === '' || !str_starts_with($key, 'field_jc_laser_')) {
        return $field;
    }
    if (!isset(justccell_acf_laser_engraving_product_field_map()[$key])) {
        return false;
    }
    return $field;
});
...
/**
 * Category defaults — section 3.2 (fallback when product fields are empty).
 * Admin UI disabled; values may still be read via get_field( …, 'product_cat_{id}' ).
 *
 * @return array<string, mixed>
 */
function justccell_acf_laser_engraving_category_group(): array
{
    return [
        'key'    => 'group_jc_laser_engraving_cat',
        'title'  => 'Laser engraving defaults',
        'fields' => [
            [
                'key'     => 'field_jc_laser_cat_intro',
                'label'   => '',
                'name'    => '',
                'type'    => 'message',
                'message' => '<p>Fallback values when a product has engraving enabled but leaves canvas / pricing empty. Products override these defaults.</p>',
                'new_lines' => '',
                'esc_html'  => 0,
            ],
            [
                'key'   => 'field_jc_laser_cat_setup',
                'label' => 'Default setup fee',
                'name'  => 'laser_setup_fee',
                'type'  => 'number',
                'min'   => 0,
                'step'  => '0.01',
                'wrapper' => ['width' => '33'],
            ...
            [
                'key'          => 'field_jc_laser_cat_tiers',
                'label'        => 'Default tiered pricing',
                'name'         => 'laser_tiered_pricing_matrix',
                'type'         => 'repeater',
                'layout'       => 'table',
                'button_label' => 'Add qty band',
                'wrapper'      => ['width' => '67'],
                'sub_fields'   => [
                    [
                        'key'   => 'field_jc_laser_cat_tier_min',
                        'label' => 'Min qty',
                        'name'  => 'min_qty',
                        'type'  => 'number',
                        'min'   => 1,
                    ...
                    [
                        'key'   => 'field_jc_laser_cat_tier_max',
                        'label' => 'Max qty (0 = open)',
                        'name'  => 'max_qty',
                        'type'  => 'number',
                        'min'   => 0,
                    ...
                    [
                        'key'   => 'field_jc_laser_cat_tier_ppu',
                        'label' => 'Price per unit',
                        'name'  => 'price_per_unit',
                        'type'  => 'number',
                        'min'   => 0,
            ...
            [
                'key'           => 'field_jc_laser_cat_bg',
                'label'         => 'Default canvas background',
                'name'          => 'laser_canvas_background_image',
                'type'          => 'image',
                'return_format' => 'array',
                'preview_size'  => 'medium',
            ],
            [
                'key'          => 'field_jc_laser_cat_zones',
                'label'        => 'Default safe zones',
                'name'         => 'laser_safe_zone_coordinates',
                'type'         => 'repeater',
                'layout'       => 'table',
                'button_label' => 'Add safe zone',
                'sub_fields'   => [
                    [
                        'key'   => 'field_jc_laser_cat_zone_x',
                        'label' => 'X',
                        'name'  => 'x',
                        'type'  => 'number',
                        'step'  => 1,
