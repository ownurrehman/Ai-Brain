...
add_action('acf/init', static function (): void {
    ...
    foreach (
        [
            ...
            'justccell_register_acf_packaging_coming_soon_page',
    ...
    return [
        ...
        'fields' => [
            [
                ...
                'return_format' => 'array',
                'preview_size'  => 'thumbnail',
                'instructions'  => 'Hero background. Empty uses the WooCommerce product image.',
            ],
            [
                'key'          => 'field_jc_prod_banner_heading',
                'label'        => 'Banner heading',
                'name'         => 'clone_banner_heading',
                'type'         => 'text',
                'wrapper'      => ['width' => '30'],
                'instructions' => 'Rendered as the page H1 on the hero. Leave empty to use the product name.',
            ],
            [
                'key'          => 'field_jc_prod_tagline',
                'label'        => 'Banner text',
                'name'         => 'clone_tagline',
                'type'         => 'textarea',
                'rows'         => 3,
                'wrapper'      => ['width' => '70'],
                'instructions' => 'Short line under the banner heading. Leave empty to hide it. Do not paste the product description here.',
            ],
            [
                ...
                'type'         => 'text',
                'wrapper'      => ['width' => '50'],
                'instructions' => 'Heading above the specs. Leave empty to use the product name.',
            ],
            [
                'key'          => 'field_jc_prod_subtitle',
                'label'        => 'Blue text below heading',
                'name'         => 'clone_subtitle',
                'type'         => 'text',
                'wrapper'      => ['width' => '50'],
                'instructions' => 'Short accent line under the product heading. Leave empty to hide it. Product description belongs in the WooCommerce Product description box.',
            ],
            [
                ...
                'instructions' => 'Bullet list under the product heading (capacity, voltage, size, …).',
                'sub_fields'   => [
                    [
    ...
    justccell_acf_register_field_group([
        ...
        'fields' => [
            [
                ...
                'type'          => 'select',
                'choices'       => [
                    'auto'          => 'Auto (mega if children look like product tabs; else dropdown)',
                    'products_mega' => 'Products mega (tabs + product cards)',
                    'dropdown'      => 'Text dropdown',
                    'link'          => 'Plain link (ignore children)',
                ],
                'default_value' => 'auto',
                'return_format' => 'value',
            ],
            [
                ...
                'name'          => 'mega_products',
                'type'          => 'relationship',
                'instructions'  => 'Set on each tab under Products or CCELL 3.0 (not on the parent). Only products in that tab’s category are shown; others are skipped. Leave empty to auto-fill. Drag to reorder. Max 8.',
                'post_type'     => ['product'],
                'filters'       => ['search'],
                'return_format' => 'id',
                'min'           => 0,
