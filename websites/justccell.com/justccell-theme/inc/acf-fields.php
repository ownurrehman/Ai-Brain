...
function justccell_acf_product_clone_group(): array
{
    return [
        ...
        'fields' => [
            ...
            [
                'key'     => 'field_jc_prod_details_intro',
                'label'   => 'Extra detail photos',
                'type'    => 'message',
                'message' => 'Optional wide strip under heating (max 3). Photo 1 is the large tile.',
            ],
            [
                'key'           => 'field_jc_prod_detail_1',
                'label'         => 'Detail photo 1 — large tile',
                'name'          => 'clone_detail_1',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'thumbnail',
            ...
            [
                'key'           => 'field_jc_prod_detail_2',
                'label'         => 'Detail photo 2',
                'name'          => 'clone_detail_2',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'thumbnail',
            ...
            [
                'key'           => 'field_jc_prod_detail_3',
                'label'         => 'Detail photo 3',
                'name'          => 'clone_detail_3',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'thumbnail',
            ...
            [
                'key'           => 'field_jc_prod_evomax_title_tag',
                'label'         => 'Heating heading tag',
                'name'          => 'clone_evomax_title_tag',
                'type'          => 'select',
                'choices'       => ['h2' => 'H2', 'h3' => 'H3'],
                'default_value' => 'h2',
                'wrapper'       => ['width' => '50'],
            ...
            [
                'key'     => 'field_jc_prod_catalog_intro',
                'label'   => 'Catalog & menu',
                'type'    => 'message',
                'message' => 'Listing card + Products mega menu.',
            ],
            [
                'key'     => 'field_jc_prod_card_tagline',
                'label'   => 'Listing tagline',
                'name'    => 'clone_card_tagline',
                'type'    => 'text',
                'wrapper' => ['width' => '50'],
            ],
            [
                'key'     => 'field_jc_prod_card_capacity',
                'label'   => 'Listing capacity',
                'name'    => 'clone_card_capacity',
                'type'    => 'text',
                'wrapper' => ['width' => '50'],
            ],
            [
                'key'           => 'field_jc_prod_card_image',
                'label'         => 'Card image',
                'name'          => 'clone_card_image',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'thumbnail',
                'instructions'  => 'Optional override for catalog/mega card. Empty uses the product image.',
            ],
            [
                'key'     => 'field_jc_prod_oil_group',
                'label'   => 'Oil group (All-In-Ones mega)',
                'name'    => 'clone_oil_group',
                'type'    => 'text',
                'wrapper' => ['width' => '50'],
            ],
            [
                'key'           => 'field_jc_prod_mega_featured',
                'label'         => 'Featured in Products mega',
                'name'          => 'clone_mega_featured',
                'type'          => 'true_false',
                'ui'            => 1,
                'wrapper'       => ['width' => '50'],
            ],
...
function justccell_register_acf_header_menu(): void
{
    ...
    justccell_acf_register_field_group([
        ...
        'title'  => 'Product mega (optional)',
        'fields' => [
            [
                'key'           => 'field_jc_header_mega_products',
                'label'         => 'Featured product cards',
                'name'          => 'mega_products',
                'type'          => 'relationship',
                'instructions'  => 'Only for a submenu row that is a Product category (or links to one). Leave empty to auto-fill from that category. Drag to reorder. Max 8.',
                'post_type'     => ['product'],
                'filters'       => ['search'],
                'return_format' => 'id',
                'min'           => 0,
