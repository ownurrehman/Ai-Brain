...
| Q5 | Stay **inquiry-only** long term, or add card checkout? **2026-08-28:** they asked to integrate **their payment gateway** plus **UPS and FedEx**. **2026-09-05:** **Add to cart** + AJAX drawer live for tier-priced SKUs; **Viva Smart Checkout** is the chosen gateway (sandbox on dev first). Paid checkout still off until Viva + VAT credentials exist. | Payments, PCI, shipping |
