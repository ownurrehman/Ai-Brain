...
/**
 * Laser field groups are scoped in Local JSON (`taxonomy` / `post_type` locations).
 * Do not return false from acf/load_field_group — ACFML translateGroups fatals on false entries.
 */
