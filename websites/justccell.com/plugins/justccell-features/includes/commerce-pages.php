 ...
 */
function justccell_empty_cart_suggested_products(int $limit = 4): array
{
    ...
    return array_values(array_filter($products, static fn ($product): bool => $product instanceof WC_Product));
}
...
add_action('wp_enqueue_scripts', static function (): void {
    ...
    if (is_cart() || is_checkout() || is_account_page()) {
        wp_enqueue_script(
            ...
            JUSTCCELL_FEATURES_URL . 'assets/js/cart-wording.js',
            [],
