...
## Identity
Tonic Physio is a community-focused physiotherapy clinic in Milton, Ontario. The voice is warm, professional, trustworthy, and educational.

## Personality Traits

| Trait | How It Sounds |
|-------|---------------|
| Caring | "We understand that pain affects every part of your life..." |
| Professional | "Our registered physiotherapists use evidence-based techniques..." |
| Accessible | "You do not need a doctor's referral to start physiotherapy." |
| Actionable | "Here is what you can do today to start feeling better..." |
...
| "Contact us now!" | "Book a consultation to see if this is right for you." |
