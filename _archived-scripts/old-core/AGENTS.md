...
**Antigravity catalog:** [Antigravity Awesome Skills](https://github.com/sickn33/antigravity-awesome-skills) lives as a **git submodule** at **`antigravity-awesome-skills/`** (next to **`skills/`**). See **`core/ANTIGRAVITY.md`** and **`core/SKILLS.md`**.
...
- `agents/MASTER-INDEX.md` — directory of all active agents and roles
