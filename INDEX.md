...
```mermaid
graph TD
    Brain["🧠 Ai Brain (Master Hub)"]
    
    Brain --> Agents["🤖 Agent Fleet"]
    ...
    Agents --> Alpha["[[agents/alpha/MEMORY|Alpha (Stealth)]]"]
    Agents --> Chronos["[[agents/chronos/MEMORY|Chronos (Scheduler)]]"]
    Agents --> Enigma["[[agents/enigma/MEMORY|Enigma (SEO Content)]]"]
    Agents --> Emilia["[[agents/emilia/MEMORY|Emilia (Outreach)]]"]
    Agents --> Scout["[[agents/scout/MEMORY|Scout (SERP Intel)]]"]
