...
| `skills/seo/SKILL.md` | **Master SEO Spec:** Research, strategy, and technical audits. | Analyzing keywords or SERP intent. | Task is pure writing/implementation. |
| `skills/content-writing/SKILL.md` | **Master Content Spec:** Search-aware assets and technical prose. | Drafting or improving blog/web copy. | Task is pure research or publishing. |
...
| `skills/saas-development/SKILL.md` | **Master SaaS Spec:** NestJS, tenancy, and backend architecture. | Scalable backend and job queue design. | Task is simple UI or non-SaaS work. |
...
| `skills/verification/SKILL.md` | **Master Verification Spec:** TDD, Hardening, and Loop Prevention. | Hardening code and fixing recursion bugs. | Task is content or strategic research. |
